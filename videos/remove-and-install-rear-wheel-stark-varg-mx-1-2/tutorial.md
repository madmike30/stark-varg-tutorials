# Remove and Install Rear Wheel - Stark VARG MX 1.2 / EX

Source video: `Remove and Install Rear Wheel - Stark VARG MX 1.2` by Stark Future Official
...
Remove or move aside the surrounding part, cover, or hardware needed to reach the Rear Wheel.
...
Remove the bolts, screws, nuts, or clips that directly secure the Rear Wheel.
...
Lift, slide, or guide the Rear Wheel out of its mounting position once the retaining hardware is removed.
...
Install the main retaining hardware for the Rear Wheel by hand first, then tighten it evenly.
...
- Tighten the rear wheel axle lock bolt: **80 Nm** from the official Stark documentation.
