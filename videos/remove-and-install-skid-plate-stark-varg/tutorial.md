...
Remove or move aside the surrounding part, cover, or hardware needed to reach the Skid Plate.
...
Remove the bolts, screws, nuts, or clips that directly secure the Skid Plate.
...
Lift, slide, or guide the Skid Plate out of its mounting position once the retaining hardware is removed.
...
Install the main retaining hardware for the Skid Plate by hand first, then tighten it evenly.
