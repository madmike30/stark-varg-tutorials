...
Remove or move aside the surrounding part, cover, or hardware needed to reach the Top Steering Bearing.

Keep the removed fasteners organized in sequence so reassembly matches the video.

![Step 1 - prepare access to the top steering bearing](assets/screenshots/step_01_prepare-access-to-the-top-steering-bearing.jpg)

### 2. Remove the visible retaining hardware for the Top Steering Bearing

Remove the bolts, screws, nuts, or clips that directly secure the Top Steering Bearing.

Support the component as the last fastener is removed.

![Step 2 - remove the visible retaining hardware for the top steering bearing](assets/screenshots/step_02_remove-the-visible-retaining-hardware-for-the-top-steering-b.jpg)
...
![Step 3 - release any bracket, clip, or coupling attached to the top steering bearing](assets/screenshots/step_03_release-any-bracket-clip-or-coupling-attached-to-the-top-ste.jpg)

### 4. Remove the Top Steering Bearing from the bike

Lift, slide, or guide the Top Steering Bearing out of its mounting position once the retaining hardware is removed.

Inspect the removed part and the mounting points before reassembly.

![Step 4 - remove the top steering bearing from the bike](assets/screenshots/step_04_remove-the-top-steering-bearing-from-the-bike.jpg)
...
![Step 5 - position the top steering bearing for installation](assets/screenshots/step_05_position-the-top-steering-bearing-for-installation.jpg)
...
![Step 6 - reconnect or refit the support pieces for the top steering bearing](assets/screenshots/step_06_reconnect-or-refit-the-support-pieces-for-the-top-steering-b.jpg)

### 7. Install the retaining hardware for the Top Steering Bearing

Install the main retaining hardware for the Top Steering Bearing by hand first, then tighten it evenly.

Check that the component remains aligned while the hardware is brought fully home.

![Step 7 - install the retaining hardware for the top steering bearing](assets/screenshots/step_07_install-the-retaining-hardware-for-the-top-steering-bearing.jpg)
...
![Step 8 - verify the completed installation of the top steering bearing](assets/screenshots/step_08_verify-the-completed-installation-of-the-top-steering-bearin.jpg)
