...
Remove or move aside the surrounding part, cover, or hardware needed to reach the VCU.
...
Remove the bolts, screws, nuts, or clips that directly secure the VCU.
...
Lift, slide, or guide the VCU out of its mounting position once the retaining hardware is removed.
...
Install the main retaining hardware for the VCU by hand first, then tighten it evenly.
