...
Remove the surrounding parts needed to expose the Spoiler Assembly mounting points shown in the video.

Keep the removed fasteners organized in sequence so reassembly matches the video.

![Step 1 - prepare access to the spoiler assembly](assets/screenshots/step_01_prepare-access-to-the-spoiler-assembly.jpg)

### 2. Remove the visible retaining hardware for the Spoiler Assembly

Remove the visible fasteners that secure the Spoiler Assembly and keep the hardware in removal order.

Support the component as the last fastener is removed.

![Step 2 - remove the visible retaining hardware for the spoiler assembly](assets/screenshots/step_02_remove-the-visible-retaining-hardware-for-the-spoiler-assemb.jpg)
...
![Step 3 - release any bracket, clip, or coupling attached to the spoiler assembly](assets/screenshots/step_03_release-any-bracket-clip-or-coupling-attached-to-the-spoiler.jpg)

### 4. Remove the Spoiler Assembly from the bike

Remove the Spoiler Assembly from the bike once the remaining supports and fasteners are free.

Inspect the removed part and the mounting points before reassembly.

![Step 4 - remove the spoiler assembly from the bike](assets/screenshots/step_04_remove-the-spoiler-assembly-from-the-bike.jpg)
...
Install the Spoiler Assembly retaining hardware by hand first so the part stays aligned in its mounting points.
...
![Step 7 - install the retaining hardware for the spoiler assembly](assets/screenshots/step_07_install-the-retaining-hardware-for-the-spoiler-assembly.jpg)
...
![Step 8 - verify the completed installation of the spoiler assembly](assets/screenshots/step_08_verify-the-completed-installation-of-the-spoiler-assembly.jpg)
