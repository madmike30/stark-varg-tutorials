...
![Step 1 - prepare the bike for a software update](assets/screenshots/step_01_prepare-the-bike-for-a-software-update.jpg)
...
![Step 2 - access the software update screen or workflow](assets/screenshots/step_02_access-the-software-update-screen-or-workflow.jpg)

### 3. Review the available update

Confirm the update shown on-screen before starting the installation process.

![Step 3 - review the available update](assets/screenshots/step_03_review-the-available-update.jpg)
...
![Step 4 - start the software update](assets/screenshots/step_04_start-the-software-update.jpg)

### 5. Wait for the update to complete

Allow the progress sequence to finish without interrupting power, controls, or connections.

![Step 5 - wait for the update to complete](assets/screenshots/step_05_wait-for-the-update-to-complete.jpg)
...
![Step 6 - confirm the updated software status](assets/screenshots/step_06_confirm-the-updated-software-status.jpg)
