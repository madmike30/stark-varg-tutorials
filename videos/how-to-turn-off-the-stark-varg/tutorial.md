...
![Step 1 - stabilize the bike before powering down](assets/screenshots/step_01_stabilize-the-bike-before-powering-down.jpg)

### 2. Locate the power-off control

Use the same control area shown in the video for the shutdown command.

![Step 2 - locate the power-off control](assets/screenshots/step_02_locate-the-power-off-control.jpg)

### 3. Switch the bike OFF

Perform the power-off action shown and wait for the display and system indicators to power down.

![Step 3 - switch the bike off](assets/screenshots/step_03_switch-the-bike-off.jpg)

### 4. Confirm the bike has shut off

Verify the bike display and active indicators are off before leaving the bike unattended.

![Step 4 - confirm the bike has shut off](assets/screenshots/step_04_confirm-the-bike-has-shut-off.jpg)
