...
Remove or move aside the surrounding part, cover, or hardware needed to reach the Charging Port.
...
Remove the bolts, screws, nuts, or clips that directly secure the Charging Port.
...
Lift, slide, or guide the Charging Port out of its mounting position once the retaining hardware is removed.
...
Install the main retaining hardware for the Charging Port by hand first, then tighten it evenly.
