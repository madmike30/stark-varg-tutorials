...
![Step 1 - bring the bike to a controlled stop](assets/screenshots/step_01_bring-the-bike-to-a-controlled-stop.jpg)

### 2. Use the disengagement control

Operate the control shown in the video to move the bike out of the engaged state.

![Step 2 - use the disengagement control](assets/screenshots/step_02_use-the-disengagement-control.jpg)

### 3. Disengage the drive system

Complete the disengagement action and wait for the bike to confirm the state change.

![Step 3 - disengage the drive system](assets/screenshots/step_03_disengage-the-drive-system.jpg)
...
![Step 4 - verify the bike is no longer engaged](assets/screenshots/step_04_verify-the-bike-is-no-longer-engaged.jpg)

### 5. Prepare for shutdown or service

Once disengaged, continue with shutdown, charging, transport, or service as needed.

![Step 5 - prepare for shutdown or service](assets/screenshots/step_05_prepare-for-shutdown-or-service.jpg)
