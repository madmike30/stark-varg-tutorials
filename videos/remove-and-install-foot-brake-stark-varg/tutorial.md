...
Remove or move aside the surrounding part, cover, or hardware needed to reach the Foot Brake.

Keep the removed fasteners organized in sequence so reassembly matches the video.

![Step 1 - prepare access to the foot brake](assets/screenshots/step_01_prepare-access-to-the-foot-brake.jpg)

### 2. Remove the visible retaining hardware for the Foot Brake

Remove the bolts, screws, nuts, or clips that directly secure the Foot Brake.

Support the component as the last fastener is removed.

![Step 2 - remove the visible retaining hardware for the foot brake](assets/screenshots/step_02_remove-the-visible-retaining-hardware-for-the-foot-brake.jpg)
...
![Step 3 - release any bracket, clip, or coupling attached to the foot brake](assets/screenshots/step_03_release-any-bracket-clip-or-coupling-attached-to-the-foot-br.jpg)

### 4. Remove the Foot Brake from the bike

Lift, slide, or guide the Foot Brake out of its mounting position once the retaining hardware is removed.

Inspect the removed part and the mounting points before reassembly.

![Step 4 - remove the foot brake from the bike](assets/screenshots/step_04_remove-the-foot-brake-from-the-bike.jpg)
...
![Step 5 - position the foot brake for installation](assets/screenshots/step_05_position-the-foot-brake-for-installation.jpg)
...
![Step 6 - reconnect or refit the support pieces for the foot brake](assets/screenshots/step_06_reconnect-or-refit-the-support-pieces-for-the-foot-brake.jpg)

### 7. Install the retaining hardware for the Foot Brake

Install the main retaining hardware for the Foot Brake by hand first, then tighten it evenly.

Check that the component remains aligned while the hardware is brought fully home.

![Step 7 - install the retaining hardware for the foot brake](assets/screenshots/step_07_install-the-retaining-hardware-for-the-foot-brake.jpg)
...
![Step 8 - verify the completed installation of the foot brake](assets/screenshots/step_08_verify-the-completed-installation-of-the-foot-brake.jpg)
