# Remove and Install Front Wheel - Stark VARG MX 1.2 / EX

Source video: `Remove and Install Front Wheel - Stark VARG MX 1.2` by Stark Future Official
...
Remove or move aside the surrounding part, cover, or hardware needed to reach the Front Wheel.
...
Remove the bolts, screws, nuts, or clips that directly secure the Front Wheel.
...
Lift, slide, or guide the Front Wheel out of its mounting position once the retaining hardware is removed.
...
- Tighten the front wheel axle lock bolt: **35 Nm** from the official Stark documentation.
- Tighten the front wheel clamp bolts: **15 Nm** from the official Stark documentation.
