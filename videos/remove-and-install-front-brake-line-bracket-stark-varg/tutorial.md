...
Remove or move aside the surrounding part, cover, or hardware needed to reach the Front Brake Line Bracket.
...
Remove the bolts, screws, nuts, or clips that directly secure the Front Brake Line Bracket.
...
Lift, slide, or guide the Front Brake Line Bracket out of its mounting position once the retaining hardware is removed.
...
Install the main retaining hardware for the Front Brake Line Bracket by hand first, then tighten it evenly.
