...
![Step 1 - unscrew the front number plate bolt](assets/screenshots/step_01_unscrew-the-front-number-plate-bolt.jpg)

### 2. Remove the number plate up and outward

Remove the number plate up and outward.

![Step 2 - remove the number plate up and outward](assets/screenshots/step_02_remove-the-number-plate-up-and-outward.jpg)
...
![Step 3 - carefully work the brake line out of the number plate brackets](assets/screenshots/step_03_carefully-work-the-brake-line-out-of-the-number-plate-brackets.jpg)
...
![Step 4 - carefully fit the brake line in the number plate brackets](assets/screenshots/step_04_carefully-fit-the-brake-line-in-the-number-plate-brackets.jpg)

### 5. Slide the number plate in the front fender slots

Slide the number plate in the front fender slots.

![Step 5 - slide the number plate in the front fender slots](assets/screenshots/step_05_slide-the-number-plate-in-the-front-fender-slots.jpg)

### 6. Hold the front number plate with the holes aligned

Hold the front number plate with the holes aligned.

![Step 6 - hold the front number plate with the holes aligned](assets/screenshots/step_06_hold-the-front-number-plate-with-the-holes-aligned.jpg)
