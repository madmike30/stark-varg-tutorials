...
![Step 1 - stabilize the bike before power-up](assets/screenshots/step_01_stabilize-the-bike-before-power-up.jpg)

### 2. Locate the main power control

Use the control shown in the video to begin the startup sequence for the bike.

![Step 2 - locate the main power control](assets/screenshots/step_02_locate-the-main-power-control.jpg)

### 3. Switch the bike ON

Press the power control as shown and allow the bike electronics and display to boot fully.

![Step 3 - switch the bike on](assets/screenshots/step_03_switch-the-bike-on.jpg)
...
![Step 4 - confirm the bike has powered up correctly](assets/screenshots/step_04_confirm-the-bike-has-powered-up-correctly.jpg)
...
![Step 5 - verify normal startup status](assets/screenshots/step_05_verify-normal-startup-status.jpg)
