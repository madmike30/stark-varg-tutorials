...
Remove or move aside the surrounding part, cover, or hardware needed to reach the Pull Rod.
...
Remove the bolts, screws, nuts, or clips that directly secure the Pull Rod.
...
Lift, slide, or guide the Pull Rod out of its mounting position once the retaining hardware is removed.
...
Install the main retaining hardware for the Pull Rod by hand first, then tighten it evenly.
