...
Remove or move aside the surrounding part, cover, or hardware needed to reach the Handlebar.
...
Remove the bolts, screws, nuts, or clips that directly secure the Handlebar.
...
Lift, slide, or guide the Handlebar out of its mounting position once the retaining hardware is removed.
...
Install the main retaining hardware for the Handlebar by hand first, then tighten it evenly.
