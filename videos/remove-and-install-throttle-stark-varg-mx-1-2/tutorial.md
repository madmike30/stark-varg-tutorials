# Remove and Install Throttle - Stark VARG MX 1.2 / EX

Source video: `Remove and Install Throttle - Stark VARG MX 1.2` by Stark Future Official
...
Remove or move aside the surrounding part, cover, or hardware needed to reach the Throttle.
...
Remove the bolts, screws, nuts, or clips that directly secure the Throttle.
...
Lift, slide, or guide the Throttle out of its mounting position once the retaining hardware is removed.
...
Install the main retaining hardware for the Throttle by hand first, then tighten it evenly.
...
| Component | Torque |
| --- | ---: |
| Tighten the throttle bolt | 2.5 Nm |

Verified torque items:

- Tighten the throttle bolt: **2.5 Nm** from the official Stark documentation.
