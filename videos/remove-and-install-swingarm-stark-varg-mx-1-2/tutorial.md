# Remove and Install Swingarm - Stark VARG MX 1.2
...
![Step 1 - prepare access to the swingarm](assets/screenshots/step_01_prepare-access-to-the-swingarm.jpg)

### 2. Remove the visible fasteners securing the Swingarm

Remove the visible fasteners securing the Swingarm.

![Step 2 - remove the visible fasteners securing the swingarm](assets/screenshots/step_02_remove-the-visible-fasteners-securing-the-swingarm.jpg)

### 3. Release the Swingarm from its mounting position

Release the Swingarm from its mounting position.

![Step 3 - release the swingarm from its mounting position](assets/screenshots/step_03_release-the-swingarm-from-its-mounting-position.jpg)
...
![Step 5 - position the swingarm for installation](assets/screenshots/step_05_position-the-swingarm-for-installation.jpg)

### 6. Install the retaining hardware for the Swingarm

Install the retaining hardware for the Swingarm.

![Step 6 - install the retaining hardware for the swingarm](assets/screenshots/step_06_install-the-retaining-hardware-for-the-swingarm.jpg)

### 7. Align the Swingarm in its final position

Align the Swingarm in its final position.

![Step 7 - align the swingarm in its final position](assets/screenshots/step_07_align-the-swingarm-in-its-final-position.jpg)
